            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
               <!--  <li><a href="index.php?view=raportuts&act=detailguru"><i class="fa fa-circle-o"></i> Input Nilai UTS</a></li> -->
                <li><a href="index.php?view=raport&act=detailguru"><i class="fa fa-circle-o"></i> Input jam Mengajar</a></li>
                <li><a href="index.php?view=capaianhasilbelajar"><i class="fa fa-circle-o"></i>Input nilai sikap </a></li>
              </ul>
            </li><!-- 
