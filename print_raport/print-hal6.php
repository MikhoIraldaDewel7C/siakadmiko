...
<table border=0 width=100%>
  <tr>
    ...
    <td width="520"align="center">Mengetahui <br> Kepala SMPN 1 Kahayan Hilir</td>
    <td width="260" align="left">Pulang Pisau, <?php echo tgl_raport(date("Y-m-d")); ?> <br> Wali Kelas</td>
  </tr>
  <tr>
