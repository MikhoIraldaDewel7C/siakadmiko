        ...
        <div class='box-body'>
          ...
          <div class='panel-body'>
              <table class='table table-bordered table-striped'>
                                ...
                                <tr>
                                  <th style='border:1px solid #e3e3e3; width:55px'><center>Tugas 1</center></th>
                                  <th style='border:1px solid #e3e3e3; width:55px'><center>Tugas 2</center></th>
                                  <th style='border:1px solid #e3e3e3; width:55px'><center>UH 1</center></th>
                                  <th style='border:1px solid #e3e3e3; width:55px'><center>UH 2</center></th>
                                  <th style='border:1px solid #e3e3e3; width:55px'><center>UAS</center></th>
                                </tr>
                              <tbody>";
                              $no = 1;
                                  ...
                                  if ($_GET[nisn]==$r[nisn]){
                                    ...
                                    echo "<form action='index.php?view=raport&act=listsiswa&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&tahun=$_GET[tahun]' method='POST'>
                                      <tr>
                                        ...
                                        <td align=center><input type='text' name='b' style='width:35px; text-align:center; padding:0px required'></td>
                                        <td align=center><input type='text' name='c' style='width:35px; text-align:center; padding:0px' required></td>
                                        <td align=center><input type='text' name='d' style='width:35px; text-align:center; padding:0px' required></td>
                                        <td align=center><input type='text' name='e' style='width:35px; text-align:center; padding:0px' required></td>
                                        <td align=center><input type='text' name='f' style='width:35px; text-align:center; padding:0px' required></td>
                                        <td align=center><input type='text' style='width:35px; background:#e3e3e3; border:1px solid #e3e3e3;' disabled></td>
                                        <td align=center><input type='text' style='width:35px; background:#e3e3e3; border:1px solid #e3e3e3;' disabled ></td>
