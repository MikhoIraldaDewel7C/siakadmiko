        ...
        <table id="example" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            if (isset($_GET[kelas]) and isset($_GET[tahun])) {
              $tampil = mysqli_query($koneksi, "SELECT a.*, e.nama_kelas, b.namamatapelajaran, b.kode_kurikulum, b.kode_pelajaran FROM jadwal_pelajaran a 
            ...
            while ($r = mysqli_fetch_array($tampil)) {
              $sql = "SELECT * FROM guru  where nip='$r[nip]'";
              ...
              echo "<tr><td>$no</td>
                        ...
                        ";
              if ($_SESSION[level] != 'kepala') {
                echo "<td hidden><a class='btn btn-xs btn-warning' href='index.php?view=absensiswa&act=tampilabsen&id=$r[kode_kelas]&kd=$r[kode_pelajaran]'>Buka Absensi Siswa</a></td>";
              }
              if ($_SESSION[level] != 'kepala') {
