                ...
                <div class="box-body">
                  ...
                  <?php
                    if (isset($_GET[kelas]) AND isset($_GET[tahun])){
                      $tampil = mysqli_query($koneksi,"SELECT a.*, e.nama_kelas, b.namamatapelajaran, b.kode_pelajaran, b.kode_kurikulum, c.nama_guru FROM jadwal_pelajaran a 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$r[nama_guru]</td>
                              <td hidden>$r[hari]</td>
                              <td hidden>$r[jam_mulai]</td>
                              <td hidden>$r[jam_selesai]</td>
                              <td hidden>$r[nama_ruangan]</td>";
