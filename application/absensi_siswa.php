        ...
        <table id="example" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            if (isset($_GET[kelas]) and isset($_GET[tahun])) {
              $tampil = mysqli_query($koneksi, "SELECT a.*, e.nama_kelas, b.namamatapelajaran, b.kode_pelajaran, b.kode_kurikulum FROM jadwal_pelajaran a 
      ...
      <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
            if (isset($_GET[tahun])) {
              $tampil = mysqli_query($koneksi, "SELECT a.*, e.nama_kelas, b.namamatapelajaran, b.kode_pelajaran, c.nama_guru FROM jadwal_pelajaran a 
                                            JOIN mata_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran
